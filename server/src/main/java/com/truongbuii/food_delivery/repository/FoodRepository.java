...
public interface FoodRepository extends JpaRepository<Food, Long> {
    ...
    @Query("SELECT f FROM Food f WHERE f.restaurant.slug = :restaurantSlug AND (:categoryId IS NULL OR f.category.id = :categoryId)")
    List<Food> findByRestaurantSlugAndCategoryId(
